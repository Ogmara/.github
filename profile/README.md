...
- **Run a node** — Clone [l2-node](https://github.com/Ogmara/l2-node) and join the network
- **Build an app** — Use [sdk-js](https://github.com/Ogmara/sdk-js) or [sdk-rust](https://github.com/Ogmara/sdk-rust) to build on Ogmara
- **Read the specs** — All protocol and architecture docs are in [ogmara](https://github.com/Ogmara/ogmara)
